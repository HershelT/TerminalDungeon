...
itemInfo = [
    ...
    "Wood Door" : ": Used for decroation, can be walked through by player", "Crafting Table" : ": Used for crafting complex items"}, 
    #wearbles
    ...
    "Stone Axe" : ": Provides improved attack damage", "Iron Axe" : ": Attack Boost of 2 and Breaks Doors",
    ...
    "Stone Sword" : ": Improved attack with higher durability", "Instant Kill" : ": If you have this item you are cheating!",
    "Iron Sword" : ": The shinest blade in the east creates fear in enemies" }, #maybe bomb is utility 
    #Consumables
...
itemBuffs = [
    ...
    {"Rock" : ["2", "Projectile-5 (Squares)", "Speed-0.5 (Milliseconds)"], "Wood Sword" : ["3", "Nothing"], "Stone Axe" : ["5", "Door Breaker"], "Iron Axe" : ["7", "Door Breaker", ["Wood","Stone"]],
    "Aragon's Blade" : ["9", "Fire Damage"], "Pine Bow" : ["10", "Range-10", "Speed-0.3"], "Pine Arrow" : ["2", "Projectile"],"Bomb": ["10", "Explosive"], "Stone Sword" : ["6", "Nothing"],
    "Instant Kill" : ["3000", "Death Touch"], "Stone Sword" : ["6", "Nothing"], "Iron Sword" : ["9", "Nothing"]},
