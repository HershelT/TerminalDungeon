...
def addLinesToSreen(lines, screen, rowIndex=0, colIndex=0, color='\033[m'):
    for i, row in enumerate(lines):
        for j, char in enumerate(row):
            screen[len(screen) - rowIndex+i][colIndex+j] = color + char + '\033[0m'
...
addLinesToSreen(creditsArray, startScreenArray, start_row_index-4, 36, '\033[1m\033[90m')
printScreen(startScreenArray)
waitForInput('')

addLinesToSreen(createArrayinArray(createEmptyString(credits)), startScreenArray, start_row_index-4, 36, '\033[0m')
addLinesToSreen(settingsArray, startScreenArray, start_row_index, 12, '\033[1;31m')
addLinesToSreen(["Press 'Enter' To Continue"], startScreenArray, 2, colIndex=8, color='\033[1;31m')
printScreen(startScreenArray)
waitForInput('')
time.sleep(1)
